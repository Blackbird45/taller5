...
def profile():
   # USER_ID = '1370127146421780481'
    ...
    try:
        ...
        parameter = {'results': 5}
        user_tweets = api.request(f'users/:{current_user.twitter_id}/tweets',parameter)
        ...
        print('Exception')
        print(e)
    return render_template('profile.html', user_name=current_user.email, user_tweets=user_tweets)
