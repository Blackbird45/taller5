...
def signup_post():
    ...
    twitter_id = api.request(f'users/by/twitter_username/:{twitter_username}')
    ...
    new_user = User(email=email, name=name, password=generate_password_hash(password, method='sha256'), twitter_id=twitter_id, twitter_username=twitter_username)
